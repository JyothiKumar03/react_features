    ...
    <div className="flex flex-col justify-center items-center w-full mt-5">
        <div className="flex flex-col p-5 items-center ">
            <Link to={link} >
                ...
                <div className="flex flex-col items-center text-center mt-10 w-60 p-5 bg-red-400 rounded-xl shadow-2xl  dark:bg-white/10  ring-2 ring-grey-900/5 backdrop-blur-xl  hover:bg-sky-300">
